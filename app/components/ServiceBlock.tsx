...
export default function ServiceBlock({
  ...
  return (
    <div className="flex justify-center mt-11 mb-11">
      <div className="flex flex-col md:flex-row container items-center justify-center md:mt-10 md:ml-5">
        <Image
          // lg:mr-20 md:mr-10
        ...
        <div className="textSection text-center md:text-left">
          ...
          <div className="text-xl lg:w-3/4 md:w-9/12 tracking-wide leading-7 text-textPrimary md:mr-0 md:ml-0 mr-5 ml-5">
            {children}
          </div>
        </div>
      </div>
